...
//
// Note: nimony's `echo` lives in std/syncio (import it). These examples use
// single-argument `echo` with `$`/`&` — the multi-arg form currently trips a
// nifi interpreter bug, tracked separately.
window.EXAMPLES = [
  {
    name: "Hello",
    snif: "hello.s.nif",
